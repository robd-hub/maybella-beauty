...
Real brand assets (added Sept 2026): a real photo of May (assets/hero-may.jpg, cropped from a full-page screenshot of the live homepage) is on the homepage hero banner and cropped into the founder photo circle on index.html and about.html (assets/founder-may.jpg — re-cropped wider in a later pass, the first crop was too tight on her face). The hero-may.jpg background was recolored Sept 2026 from its original coral pink (#F0999F) to match the site's --rose brand color (#c04f67) — a color-distance mask shifts near-background pixels toward rose while leaving May, the product, and the wordmark untouched (there's a very subtle softness right at her hair edge, an inherent tradeoff of automated chroma-based recoloring, judged acceptable at normal viewing scale). This recolor was intentionally NOT applied to founder-may.jpg or hero-may-mobile.jpg — both are tighter crops dominated by her face/figure with much less open background, so the same technique caused ugly blotching on her skin highlights (bright highlight areas are colorimetrically very close to the pink backdrop). Those two still use the original coral pink background; matching them would need real manual photo retouching, not automated chroma-keying.
