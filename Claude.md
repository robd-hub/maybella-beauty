...
Real brand assets (added Sept 2026): a real photo of May (assets/hero-may.jpg, cropped from a full-page screenshot of the live homepage) is on the homepage hero banner and cropped into the founder photo circle on index.html and about.html (assets/founder-may.jpg — re-cropped wider in a later pass, the first crop was too tight on her face). hero-may.jpg's background was recolored (Sept 2026, confirmed final after a revert-and-redo) from its original coral pink (#F0999F) to match the site's --rose brand color (#c04f67), via a color-distance mask — background shifted to rose, May/product/wordmark preserved. Deliberately NOT applied to founder-may.jpg or hero-may-mobile.jpg — both are tighter crops dominated by her face/figure with much less open background, and the same technique caused visible blotching on her skin highlights there (her bright highlights are colorimetrically very close to the pink backdrop, so the mask can't cleanly separate them in a tight crop). Those two still use the original coral pink background; matching them would need real manual photo retouching, not automated chroma-keying.
